...
import { ShieldCheckIcon, ArrowLeftIcon, LockClosedIcon, EnvelopeIcon, UserIcon } from "@heroicons/react/24/solid";
        ...
        <div className="game-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-blue-600 mt-1">This will be displayed on the leaderboard</p>
            </div>
